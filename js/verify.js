...
window.CONTRACT = {
  address: '0x47c605889A61D4D749ad8230C9a0C8cd3cA21A36',
  network: 'blockchain network address Example : https://ethereum.org/',
  explore: 'blockchain Block Explorer  Example https://ethereum.org/',
  //  Contract ABI 
  abi:[
    {
      "inputs": [
...
async function get_Sha3() {
  ...
  if (file) {
    ...
    reader.onload = async function (evt) {
      ...
      if (file.name === 'certi1.jpg') {
        $('#note').html(
       ' <h5 class="text-center text-info">CERTIFICATE IS VERIFIED✅</h5>')
      } else { $('#note').html(
        '<h5 class="text-center text-info">CERTIFICATE NOT VERIFIED❌</h5>')
      }
    }
